interface MessageSections { workingTextChunks: string[]; contentTextChunks: string[]; todoTextChunks: string[]; }
interface SectionUpdate { kind?: string; textChunks?: string | string[]; persisted?: MessageSections; fallbackWorkingTextChunks?: string | string[]; fallbackTodoTextChunks?: string | string[]; exclusive?: boolean; finalize?: boolean; }
/**
...
export function stripHtmlFormatting(text: unknown) {
...
export function stripMarkdownFormatting(text: unknown) {
...
export function normalizeRenderedText(text: unknown) {
...
function sanitizeTelegramHtml(text: unknown) {
    let next = safeString(text);
...
export function markdownToTelegramHtml(text: unknown) {
...
export function composeEditableMessageText(sections: MessageSections) {
    return [
...
export function updateEditableMessageSections(input: SectionUpdate) {
...
export function splitPlainText(text: unknown, maxLength: number) {
...
export function prepareText(platform: string, text: unknown, maxLength?: number) {
